...
//发布时间范围
    ...
    public static Map<String, Object> getCompanyMangerList(String name, String industry, String province, String city,
                                                           String county, String productName, String finacing, String approved, String freezed) {
        ...
        if (DataUtils.isNotNullOrEmpty(finacing)) {
            params.put("finacing ", "'" + finacing + "'");
        }
    ...
    public static Map<String, Object> countArticleNum() {
        Map<String, Object> params = new HashMap<String, Object>();
        ...
        log.info("countArticleNum sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }


    public static Map<String, Object> getTeacherList(String title, Long category, Long startAt,
                                                     Long endAt, Long status) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(title)) {
        ...
        log.info("getTeacherList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }


    public static Map<String, Object> getExchangeList(String title, Long startAt,
                                                      Long endAt, Long status) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(title)) {
            params.put("title", "'" + title + "'");
        ...
        params.put("@table", " exchange ");

        log.info("getExchangeList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> getActivityList(String title, Long startAt,
                                                      Long endAt, Long status) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(title)) {
            params.put("title", "'" + title + "'");
        ...
        params.put("@table", " activity ");

        log.info("getActivityList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> getAdmissionEmploymentList(String title, Long category, Long startAt,
                                                                 Long endAt, Long status) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(title)) {
            params.put("title", "'" + title + "'");
        ...
        params.put("@table", " admission_employment ");

        log.info("getAdmissionEmploymentList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> getGraduateList(String title, Long startAt,
                                                      Long endAt, Long status) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(title)) {
            params.put("title", "'" + title + "'");
        ...
        params.put("@table", " graduate ");

        log.info("getGraduateList sql is " + SQLUtil.convert2Sql(params, 0, 0));
    ...
    public static Map<String, Object> searchActivityList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        params.put("@order", " create_at desc ");
        ...
        log.info("searchActivityList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> searchAdmissionEmploymentList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        ...
        log.info("searchAdmissionEmploymentList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> searchExchangeList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        ...
        log.info("searchExchangeList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> searchGraduateList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        ...
        log.info("searchGraduateList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> searchTeacherList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        ...
        log.info("searchTeacherList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> searchInternshipList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        ...
        params.put("@table", " internship ");

        log.info("searchInternshipList sql is " + SQLUtil.convert2Sql(params, 0, 0));

        return params;
    }

    public static Map<String, Object> searchMajorList(String words) {
        Map<String, Object> params = new HashMap<String, Object>();
        if (DataUtils.isNotNullOrEmpty(words)) {
            params.put("title & like ", "'%" + words + "%'"+"or content like"+"'%"+words+"%'");
        }
        ...
        log.info("searchMajorList sql is " + SQLUtil.convert2Sql(params, 0, 0));
