...
<%@ include file="../../../includes/includes.jsp"%>
	...
	<div id="articleDetailApp" ng-app="articleDetailApp">
		<div ng-controller="articleDetailController">
			...
			<div class="portlet">
			    ...
			    <form class="form-horizontal" role="form" name="articleForm">
			        ...
			        <div class="col-sm-6">
			          <input type="text" class="form-control" name="order" ng-model="article.order" ng-bind="article.order" placeholder="请输入排序" required>
			        </div>
			        </div>
	 ...
	 <script src="/r/js-src/web/college-home-service/article/articleDetail.js"></script>
