...
function projectRouteConfig($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('field.dashboard', {
           ...
           //教材管理
        .state('field.internshipList', {
            url: '/internshipList',
            templateUrl: 'views/internshipList.html',
            controller: 'InternshipListController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/internship/internshipListController.js'
                ])
            }
        })
        //教材编辑等管理
        .state('field.internshipDetails', {
            url: '/internshipDetails/:id',
            templateUrl: 'views/internshipDetails.html',
            controller: 'InternshipDetailController',
            controllerAs: 'vm',
            resolve: {
                loadMyFile: _lazyLoad([
                    'js/controllers/internship/internshipDetailsController.js'
                ])
            }
        })      
